...
The Morphia module bridge play.db.Model to mongodb. This module depends on morphia framework project on <a href="http://code.google.com/p/morphia/">googlecode</a>

h2. <a>Motivation</a>

In the begining I want to use existing <a href="http://www.playframework.org/modules/mongo">play-mongo</a> plugin. However it lack some features I needed including:
...
I've come across with <a href="http://code.google.com/p/morphia/">morphia</a> project and feel it is exactly what I needed. I just need to write some code to 
...
p. Well this is a problem of Play. Check <a href="http://groups.google.com/group/play-framework/browse_thread/thread/a290fabc41f787ec">this</a> thread
