...
The Morphia module bridge play.db.Model to mongodb. This module depends on morphia project hosted on <a href="http://code.google.com/p/morphia/">googlecode</a>
