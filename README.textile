...
p(note). *Important changes*: play-morphia 1.5.0e updates the morphia library to org.mongodb.morphia 1.2.1 and mongo java driver to org.mongodb 3.2.2. Please update your morphia username/password configuration to include them in the connection url, as they are currently unsupported.
