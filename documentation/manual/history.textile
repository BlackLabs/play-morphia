...
* "Support MongoDB option configuration":https://github.com/greenlaw110/play-morphia/pull/83
* "Support configure MongoDB connection using url":https://github.com/greenlaw110/play-morphia/pull/79
* "Support batch insert":crud#batch-insert
* "Support @String@ type system generated ID field":model#id
* Bug fixes:
...
** "1.2.6 causes "bad type, not parametrized" exception with mongo 2.7.2 driver":https://github.com/greenlaw110/play-morphia/issues/74
