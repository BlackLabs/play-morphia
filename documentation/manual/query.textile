...
bc. List<User> johns = User.q().filter("firstName", Pattern.compile("[Jj]ohn")).asList();
...
bc. MorphiaQuery q = User.q();
q.or(q.criteria("firstName").contains("[Jj]ohn"), q.criteria("lastName").contains("[Jj]ohn"));
...
bc. Author green = Author.find("email", "greenlaw110@gmail.com").get();
