...
Welcome to PlayMorphia module documentation. This documentation is intended for the *1.2.15a release* and may significantly differ from previous module version's documentation.

Check the "version history":history

p(note). *Break changes*: For those who use *Long* as ID type, your mongodb database needs to run a script to update the
