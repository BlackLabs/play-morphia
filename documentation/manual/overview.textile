...
p(note). The content documented in this section are new to PlayMorphia v1.2.4. For life cyle annotations used before v1.2.4 please go to "Morphia documentation":http://code.google.com/p/morphia/wiki/LifecycleMethods
...
com.mongodb.DBCollection userCollection = User.col();
