...
|javax.persistence.Entity|>>|org.mongodb.morphia.annotations.Entity|
...
All Morphia model class must have an ID field defined. This is done by giving an <a href="http://code.google.com/p/morphia/wiki/AllAnnotations#Id">@org.mongodb.morphia.annotations.Id@</a> annotation to the ID property of the model. Once you have done with that your ID property in Java class will be mapped to <a href="http://www.mongodb.org/display/DOCS/Object+IDs">"_id"</a> key of the document in MongoDB.
...
# Annotate that class with <code>@org.mongodb.morphia.annotations.Entity</code> annotation
...
bc. import org.mongodb.morphia.annotations.*
...
p(note). Embedded object is actually NOT an entity at all, you should *NOT* extend embedded object to @play.modules.morphia.Model@, *neither* should you annotate embedded object with <code>@org.mongodb.morphia.annotations.Entity</code>
...
# <a href="#reference-annotate">Use <code>@org.mongodb.morphia.annotations.Reference</code> to annotate the model property</a>
...
By default Morphia will throw out @org.mongodb.morphia.mapping.MappingException@ if the referenced object could not be load due to missing data in MongoDB. This is annoying sometimes, you can let Morphia to silently ignore the missing data by using <code>@Reference(ignoreMissing = true)</code>
...
To index a single property of your model, annotate that property with <code>@org.mongodb.morphia.annotations.Indexed</code>:

bc. import org.mongodb.morphia.annotations.Indexed;
...
To create a <a href="http://www.mongodb.org/display/DOCS/Indexes#Indexes-CompoundKeysIndexes">compound index</a> you can use @org.mongodb.morphia.annotations.Indexes@ to annotate your model class:

bc. import org.mongodb.morphia.annotations.Indexes;
