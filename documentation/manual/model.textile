...
Whichever ID type is used, PlayMorphia will always generate ID value automatically. Note if you shall NOT choose @Long@ as ID type as it will cause trouble when running in a clustered environment.
