...
h3. <a name="reference-annotate">@Reference annotation</a>

Morphia provides "@Reference":http://code.google.com/docreader/#p=morphia&s=morphia&t=ReferenceAnnotation which exactly map the MongoDB <a href="http://www.mongodb.org/display/DOCS/Database+References">Database Reference</a> to Java world. Example:
...
h2. <a name="resource">Resources</a>
