...
To make the above event listener listen to @User@ and @Account@ lifecycle events you need to annotate the corresponding Model class with <code>@org.mongodb.morphia.annotations.EntityListeners</code>:
